...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="Screenshot 2024-05-12 180737.png  " class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  <body background="bg images medicine.jpeg  " style="background-repeat: no-repeat; background-size: cover;">
  <br>
  <br>
  <br>
  <br>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany. All rights reserved. BY PAVITHRA S</p>
  </footer>
...
<body>
  ...
  <body background="bg images medicine.jpeg " style="background-repeat: no-repeat; background-size: cover;"></body>
  <!-- Footer -->
...
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src=" Screenshot 2024-05-12 180615.png " class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="Screenshot 2024-05-12 180625.png" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="Screenshot 2024-05-12 180709.png  " class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
  ...
  <!-- Bootstrap JS -->
  <script src=" pavi/pharmapp/static/Screenshot 2024-05-12 180615.png"></script>
  <script src=" pavi/pharmapp/static/Screenshot 2024-05-12 180625.png"></script>
  <script src=" pavi/pharmapp/static/Screenshot 2024-05-12 180709.png "></script>
</body>
</html>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          THIRUVALLUR STREET,GUDIYATHAM<br>
          VELLORE,632602<br><br>
          <strong>Email:</strong><br>
          pavithraselvaraj@gmail.com<br><br>
...
![alt text](<Screenshot 2024-05-12 195204.png>)

![alt text](<Screenshot 2024-05-12 195232.png>)

![alt text](<Screenshot 2024-05-12 195305.png>)

![alt text](<Screenshot 2024-05-12 195141.png>)
## RESULT:
